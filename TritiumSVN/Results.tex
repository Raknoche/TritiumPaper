...
%We find agreement with Compton scattering measurements of light yield for electron recoils in xenon, shown in Fig. \ref{fig:Re_LY}. At these low energies betas and gammas leave similar track lengths and produce identical yields \cite{NEST_2013}. The calibration using the tritium beta source is applicable to the Compton scatter gamma backgrounds for the WIMP search. 
